...
export default function Sidebar() {
  ...
  const { currentUser, issues, isLoggedIn } = state;
  ...
  return (
    <aside className="sidebar">
      ...
      {isLoggedIn ? (
        <Link to="/dashboard?tab=personal" className="sidebar-user-link-wrapper">
          {/* User Profile Card */}
        ...
        <div className="sidebar-guest-card" onClick={() => dispatch({ type: 'SET_LOGIN_MODAL', payload: true })} style={{ cursor: 'pointer' }}>
